...
- Usa interfaces para tipos de datos
...
## Añadir nuevas características a la Vista Geoespacial

Para extender la funcionalidad de la Vista Geoespacial:

1. **Modifica los filtros** en `FilterPanel.tsx` si necesitas añadir nuevos criterios de filtrado.

2. **Extiende el componente LeafletMap** si necesitas nuevas funcionalidades del mapa:
   - Añadir nuevas capas
   - Soporte para nuevos tipos de visualización
   - Mejora de interacciones

3. **Actualiza el componente GeoStats** para incluir nuevas métricas o visualizaciones.

4. **Modifica GeoView.tsx** para integrar los nuevos componentes o funcionalidades.

5. **Crea o actualiza servicios API** en la carpeta `services/` para nuevas llamadas al backend.
